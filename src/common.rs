...
pub struct OCR<Ext>(pub(crate) u32, core::marker::PhantomData<Ext>);
...
#[derive(Clone, Copy, Default)]
pub struct CSD<Ext>(pub(crate) u128, core::marker::PhantomData<Ext>);
...
#[derive(Clone, Copy)]
pub struct CardStatus<Ext>(pub(crate) u32, core::marker::PhantomData<Ext>);
...
pub struct RCA<Ext>(pub(crate) u32, core::marker::PhantomData<Ext>);
